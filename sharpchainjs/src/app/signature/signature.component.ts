...
import { hexValidator } from '../shared/angularExtensions/customValidators'
...
export class SignatureComponent implements OnInit {
  ...
  kControl = new CustomFormControl('', [hexValidator])
  ...
  constructor() {
    ...
    this.kControl.setValue('340a098bb9702ee3671cf9c7301ba1afb40f5180a1685ff13ade5738a08a0be5')
  }
  ...
  onCreateSignatureClick() {
    ...
    if (this.hacking) {
      ...
      if (this.kControl.invalidOrEmpty) {
        toastr.error('must provide valid hex for \'k\' while \'hacking\'')
        return
      }
    }

    const options = this.hacking ? { k: (x) => new BN(this.kControl.value, 'hex') } : undefined
